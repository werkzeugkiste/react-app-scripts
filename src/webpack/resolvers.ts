...
// TODO: This will probably not work with Yarn-PnP / Berry
const getDependencyPath = (dependencyName: string) => resolveApp('node_modules', dependencyName);
...
export default {
    ...
    alias: {
        ...
        'react-dom': getDependencyPath('react-dom'),
